<div class="">
    ...
    <a href="{$Root.TreeLink}" class="options-item btn btn-default" title="<%t Genealogist.SHOW_CLAN 'Show this persons branch tree' %>"><i class="fa fa-pagelines" aria-hidden="true"></i></a>
