<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapse-filters"><%t Genealogist.FILTERS 'Filters' %></a>
        </h4>
    </div>

    <div id="collapse-filters" class="list-group panel-collapse collapse">
        <div class="panel-body">
            <div class="list-group-item checkbox"><label><input type="checkbox" id="ancestral" class="options-check" value="0"><%t Genealogist.ANCESTRAL_TREE 'Ancestral Tree' %></label></div>
