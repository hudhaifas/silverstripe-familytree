<div class="panel-heading clearfix">
    ...
    <div class="pull-right">
        <a href="{$Link}"><i class="fa fa-eye" aria-hidden="true"></i></a>
        <a href="{$Father.Link}"><i class="fa fa-level-up" aria-hidden="true"></i></a>
        <a href="{$Root.Link}"><i class="fa fa-undo" aria-hidden="true"></i></span></a>
    </div>
</div>
